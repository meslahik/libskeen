...
LIBSKEEN_CLASS_SERVER = 'ch.usi.dslab.mojtaba.libskeen.Server'
LIBSKEEN_CLASS_BENCHCLIENT = 'ch.usi.dslab.mojtaba.libskeen.bench.BenchClient'
DYNASTARBTREE_CLASS_CLIENT = 'ch.usi.dslab.lel.dynastarv2.btree.BPlusTreeClient'
...
SENSE_PORT = 60000
SENSE_DIRECTORY = '/home/eslahm/logs/libskeen-tcp/data'
SENSE_DURATION = 60
SENSE_WARMUP = 10
...
_class_path = [LIBSKEEN_CP, LIBSKEEN_DEPENDENCIES, SENSE_CP, SENSE_DEPENDENCIES]
