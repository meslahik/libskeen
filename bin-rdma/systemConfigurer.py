...
def generateJMcastConfiguration(nodes_available, nodes_available_rdma, numPartitions, numOracles, replicasPerPartition,
                                configFilePath,
...
def generateSystemConfigurationForJMcast(numPartitions, numOracles, saveToFile=True):
    ...
    availableNodesRDMA = common.NODES_RDMA

    systemConfiguration = generateJMcastConfiguration(availableNodes, availableNodesRDMA, numPartitions, numOracles,
